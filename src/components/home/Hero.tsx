      ...
      <div className="container flex items-center justify-between max-w-[1080px]">
        <div className="max-w-[500px]">
          <h1
            data-aos="fade-up"
            data-aos-once="true"
            className="leading-[5rem] text-6xl text-white font-semibold"
          >
            ...
            <span
              ...
              data-aos-once="true"
              data-aos-delay="300"
              className="font-cursive text-[8.4rem] leading-[3rem] font-bold text-primary"
            >
              coffee
            </span>{" "}
            in the 20th ward
        ...
        <div
          data-aos="zoom-in"
          data-aos-once="true"
          className="-mr-[60px] w-[300px] h-[300px] sm:w-[500px] sm:h-[500px]"
        >
